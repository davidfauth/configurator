package com.lenovo.imports;

import com.lenovo.results.StringResult;
...
public class Imports {
    ...
    @Procedure(name = "com.lenovo.imports.materials", mode = Mode.WRITE)
    @Description("CALL com.lenovo.imports.materials(file)")
    ...
    @Procedure(name = "com.lenovo.imports.variants", mode = Mode.WRITE)
    @Description("CALL com.lenovo.imports.variants(file)")
